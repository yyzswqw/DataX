...
public class IfNull2DefaultConverter implements Converter {
    ...
    public Object transform(String targetColumnName, Object value, Map<String, Object> param, Map<String,Object> resolvedValues) {
        if(NullUtil.isNullOrBlank(value)){
            ...
            if (cacheTargetColumnName.contains(cacheTargetColumnName)) {
                ...
                return trans(targetColumnName,o,resolvedValues);
            }else{
    ...
    private Object trans(String targetColumnName, Object o, Map<String,Object> resolvedValues) {
        Object v = o;
        List<DataConverter> dataConverters = cache.get(targetColumnName);
        for (DataConverter dataConverter : dataConverters) {
            ...
            v = con.transform(targetColumnName,v,dataConverter.getParam(),resolvedValues);
        }
        return v;
    }
}
