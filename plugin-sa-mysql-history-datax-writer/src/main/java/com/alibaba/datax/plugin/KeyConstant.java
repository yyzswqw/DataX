...
public class KeyConstant {
    ...
    public static final String MODEL_INSERT = "insert";

    public static final String MODEL_REPLACE = "replace";

    public static final String MODEL_UPDATE = "update";

    public static final String MODEL_INSERT_BATCH = "insertBatch";

    public static final String MODEL_REPLACE_BATCH = "replaceBatch";
