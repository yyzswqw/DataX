package com.alibaba.datax.customize.datax.classloader;
...
public class PluginClassLoader extends URLClassLoader {
    ...
    public static CommonReader.SAReaderPlugin getBasePlugin(String path, String classFullName, Configuration config, Map<String,Object> param){
        try {
            String curClassPath = PluginClassLoader.class.getResource("").getFile();
            ...
            log.info("plugin path：{}/plugin/{}",p,path);
            ClassLoader pluginClassLoader = PluginClassLoader.getPluginClassLoader(p+"/plugin/"+path);
            Class<CommonReader> clazz =  (Class<CommonReader>)pluginClassLoader.loadClass(classFullName);
            CommonReader basePlugin = clazz.newInstance();
            CommonReader.SAReaderPlugin instance = basePlugin.instance(config,param);
            return instance;
        }catch (Exception e){
            e.printStackTrace();
    ...
    public static ClassLoader getPluginClassLoader(String classPath) {
